 ...
 */
final class Version20210423063019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tipo_tratamiento ADD cuota_iva DOUBLE PRECISION NOT NULL, ADD importe_total DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tipo_tratamiento DROP cuota_iva, DROP importe_total');
        $this->addSql('ALTER TABLE tratamiento DROP FOREIGN KEY FK_61A4A07CDE734E51');
