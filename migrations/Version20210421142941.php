 ...
 */
final class Version20210421142941 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tratamiento ADD CONSTRAINT FK_61A4A07CF04F795F FOREIGN KEY (factura_id) REFERENCES factura (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
